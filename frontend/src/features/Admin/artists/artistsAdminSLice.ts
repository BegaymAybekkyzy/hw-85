...
export const selectAdminArtistFetchLoading = (state: RootState) =>
  state.artistsAdmin.fetchLoading;
export const selectAdminArtistDeleteLoading = (state: RootState) =>
  state.artistsAdmin.deleteLoading;
export const selectAdminArtistChangeLoading = (state: RootState) =>
  state.artistsAdmin.changeLoading;
