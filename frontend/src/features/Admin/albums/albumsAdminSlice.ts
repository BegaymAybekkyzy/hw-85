...
export const selectAdminAlbumFetchLoading = (state: RootState) =>
  state.albumsAdmin.fetchLoading;
export const selectAdminAlbumDeleteLoading = (state: RootState) =>
  state.albumsAdmin.deleteLoading;
export const selectAdminAlbumChangeLoading = (state: RootState) =>
  state.albumsAdmin.changeLoading;
