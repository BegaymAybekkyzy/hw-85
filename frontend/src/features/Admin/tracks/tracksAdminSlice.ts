...
export const selectAdminTracksFetchLoading = (state: RootState) =>
  state.tracksAdmin.fetchLoading;
export const selectAdminTracksDeleteLoading = (state: RootState) =>
  state.tracksAdmin.deleteLoading;
export const selectAdminTracksChangeLoading = (state: RootState) =>
  state.tracksAdmin.changeLoading;
