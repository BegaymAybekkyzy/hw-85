                ...
                <List>
                    <ListItem>
                        <ListItemButton component={Link} to={"/admin/artists"}>
                            <ListItemText sx={{borderBottom: "1px solid gray"}}>Artists</ListItemText>
                        </ListItemButton>
                    </ListItem>
                    <ListItem>
                        <ListItemButton component={Link} to={"/admin/albums"}>
                            <ListItemText sx={{borderBottom: "1px solid gray"}}>Albums</ListItemText>
                        </ListItemButton>
                    </ListItem> <ListItem>
                    <ListItemButton component={Link} to={"/admin/tracks"}>
                        <ListItemText sx={{borderBottom: "1px solid gray"}}>Tracks</ListItemText>
                    </ListItemButton>
                </ListItem>
